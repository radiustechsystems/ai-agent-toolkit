...
export class createBridgeOrderParametersSchema extends createToolParameters(
  z.object({
    ...
    srcChainTokenIn: z
      ...
      .describe(`
        Token address on source chain. For EVM: use 0x0000000000000000000000000000000000000000 for native token.
        For Solana: use proper token mint address
      `),
    ...
    dstChainTokenOutRecipient: z
      ...
      .describe(`
        ...
        For EVM: use 0x-prefixed address. For Solana: use base58 wallet address. Required for transaction construction!
      `),
    ...
    srcChainOrderAuthorityAddress: z
      ...
      .describe(`
        Optional: The user's wallet address that can cancel/modify the order.
        If not provided, defaults to senderAddress.
      `)
      .optional(),
