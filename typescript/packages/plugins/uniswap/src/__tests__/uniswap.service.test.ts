...
describe("UniswapService", () => {
  ...
  describe("checkApproval", () => {
    ...
    test("should handle API errors", async () => {
      ...
      await expect(service.checkApproval(mockWalletClient, params))
  ...
  describe("getQuote", () => {
    ...
    test("should handle API errors", async () => {
      ...
      await expect(service.getQuote(mockWalletClient, params))
        .rejects.toThrow(/Uniswap API request failed/);
    });
  });
  ...
  describe("swapTokens", () => {
    ...
    test("should handle transaction errors", async () => {
      ...
      await expect(service.swapTokens(mockWalletClient, params))
        .rejects.toThrow("Token swap failed");
    });
  });
});
