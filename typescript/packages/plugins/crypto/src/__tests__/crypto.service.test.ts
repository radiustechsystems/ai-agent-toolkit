...
describe('CryptoService', () => {
  ...
  describe('hashData', () => {
    test('should hash UTF-8 data', async () => {
      ...
      const result = await service.hashData(mockWalletClient as RadiusWalletInterface, parameters);
    ...
    test('should handle errors gracefully', async () => {
      ...
      const result = await service.hashData(mockFailingWallet as RadiusWalletInterface, parameters);
