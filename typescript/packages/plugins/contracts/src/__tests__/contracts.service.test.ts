...
describe('ContractsService', () => {
  ...
  describe('callContract', () => {
    ...
    test('should throw an error when contract call fails', async () => {
      ...
      await expect(
        service.callContract(mockWalletClient as RadiusWalletInterface, parameters),
  ...
  describe('executeContract', () => {
    ...
    test('should handle missing args and value', async () => {
      ...
      await service.executeContract(mockWalletClient as RadiusWalletInterface, parameters);
    ...
    test('should throw an error when contract execution fails', async () => {
      ...
      await expect(
        service.executeContract(mockWalletClient as RadiusWalletInterface, parameters),
  ...
  describe('simulateContract', () => {
    ...
    test('should handle simulation failures gracefully', async () => {
      ...
      mockWalletClient.simulateTransaction = vi
        .fn()
